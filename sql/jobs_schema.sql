...
ALTER TABLE jobs
  ADD COLUMN IF NOT EXISTS source_lang VARCHAR(8) DEFAULT NULL AFTER benefits;
...
ALTER TABLE job_applications
  ADD COLUMN IF NOT EXISTS country_id INT(11) DEFAULT NULL AFTER email;

ALTER TABLE job_applications
  ADD COLUMN IF NOT EXISTS phone_prefix VARCHAR(12) DEFAULT NULL AFTER country_id;
